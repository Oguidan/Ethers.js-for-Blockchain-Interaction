...
const callWriteFunction = async () => {
    ...
    const wallet = new ethers.Wallet("1f16fbbd60d0166b5689970989e16f343790d6c2fbdcd684c318516c336e2c28", provider);

    // Create the contract instance and connnect it to our wallet
    const contract = new ethers.Contract("0xCC8048eF226eb2383B08949F752Cf31932d487cc", ABI.humanReadableABI, wallet);
